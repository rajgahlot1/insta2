...
const [search, setSearch] = useState("");
   ...
   .slice(0, 5);
    ...
    return(
        <>
<div className='d-flex flex-column bg-white' style={{width:"397px",height:"100vh",borderTopRightRadius:"20px",borderBottomRightRadius:"20px",position:"absolute",zIndex:"1000",boxShadow: "10px 0px 14px rgba(0,0,0,0.1)"}}>
...
<div className="Sugges_profile mt-1 d-flex gap-2 flex-column w-100 bg-danger  " style={{height:"60px",cursor:"pointer"}}   onClick={() => {firebase.setSearch(false) // Log the message
    navigate(`/insta2/SearchProfile/${val.id}`);}}>
